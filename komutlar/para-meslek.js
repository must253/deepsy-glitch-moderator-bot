...
message.channel.send(e2)
    ...
    .setColor('RED')
      ...
      message.channel.send({embed})
        ...
        message.channel.send(`${client.emojis.cache.get(client.emojiler.hayır)} Madenci olmak için yeterli paran bulunmuyor. \n Gerekli olan para: **1000TL**.`)
    } else if  (para > 1000) {
    ...
    if (x === 'çiftçi') {
      ...
      db.add(`meslek_${message.author.id}`, -1)   
      message.channel.send(`${client.emojis.cache.get(client.emojiler.hayır)} Çiftçi olmak için yeterli paran bulunmuyor. \n Gerekli olan para: **2000TL**.`)
      } else if  (para > 2000) {
        const madenciE = new Discord.MessageEmbed()
        .setColor('RANDOM')
    ...
    if (x === 'tamirci') {
      ...
      db.add(`meslek_${message.author.id}`, -1)   
      message.channel.send(`${client.emojis.cache.get(client.emojiler.hayır)} tamirci olmak için yeterli paran bulunmuyor. \n Gerekli olan para: **3000TL**.`)
      } else if  (para > 3000) {
        const madenciE = new Discord.MessageEmbed()
        .setColor('RANDOM')
    ...
    if (x === 'emlakçı') {
      ...
      db.add(`meslek_${message.author.id}`, -1)   
      message.channel.send(`${client.emojis.cache.get(client.emojiler.hayır)} emlakçı olmak için yeterli paran bulunmuyor. \n Gerekli olan para: **5000TL**.`)
      } else if  (para > 5000) {
    ...
    if (x === 'mimar') {
      ...
      db.add(`meslek_${message.author.id}`, -1)   
      message.channel.send(`${client.emojis.cache.get(client.emojiler.hayır)} mimar olmak için yeterli paran bulunmuyor. \n Gerekli olan para: **10000TL**.`)
      } else if  (para > 10000) {
    ...
    if (x === 'doktor') {
      ...
      db.add(`meslek_${message.author.id}`, -1)   
      message.channel.send(`${client.emojis.cache.get(client.emojiler.hayır)} doktor olmak için yeterli paran bulunmuyor. \n Gerekli olan para: **20000TL**.`)
      } else if  (para > 20000) {
